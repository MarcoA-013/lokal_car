class BrandsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @brand.save
        format.html { redirect_to brand_url(@brand), notice: "Marca gravada." }
  ...
  def update
    respond_to do |format|
      if @brand.update(brand_params)
        format.html { redirect_to brand_url(@brand), notice: "Marca atualizada." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to brands_url, notice: "Marca excluída." }
